...
public class ScanFileAdapter<T> extends RecyclerView.Adapter<ScanFileViewHolder> {
    ...
    public ScanFileAdapter(Context context, int layoutId, List<T> datas) {
    ...
    @Override
    public ScanFileViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (headerView != null && viewType == TYPE_HEADER) {
            ...
            return new ScanFileViewHolder(context, headerView);
        }

        View view = LayoutInflater.from(context).inflate(layoutId, parent, false);
        ScanFileViewHolder holder = new ScanFileViewHolder(context, view);
        return holder;
    }

    @Override
    public void onBindViewHolder(final ScanFileViewHolder holder, int position) {
    ...
    public interface ItemDataListener<T> {
        void setItemData(ScanFileViewHolder holder, T t);
    }

    public interface ItemDatasListener<T> {
        void setItemDatas(ScanFileViewHolder holder, T t, int position);
    }
}
